...
class InviteTeamPlayers extends ConsumerStatefulWidget {
  final dynamic? team;
  const InviteTeamPlayers({super.key , this.team});

  @override
  ConsumerState<InviteTeamPlayers> createState() => _InviteTeamPlayersState();
}

class _InviteTeamPlayersState extends ConsumerState<InviteTeamPlayers> {
  ...
  void initializePlayers() async{
    final SharedPreferences prefs = await SharedPreferences.getInstance();
      ...
      Uri url = Uri.parse('https://takwira.me/api/getplayers/data?username=$username&teamId=${widget.team['team']['id']}');
  ...
  void inviteSelectedPlayers() async{
      ...
      var username = prefs.getString('username') ?? '';
      var token = prefs.getString('token') ?? '';
      Uri url = Uri.parse('https://takwira.me/api/inviteteamplayers?username=$username&teamId=${widget.team['team']['id']}');
